...
const OrderSummary = () => {
  ...
  const { setTotalWithCourier } = useCartStore();
  ...
  // Ensure totalWithCourier is set after initial calculations
  useEffect(() => {
    setTotalWithCourier(totalWithCourier);
  }, [setTotalWithCourier, totalWithCourier]);
  ...
  return (
    ...
    >
      ...
      <Link to="/proceed-to-checkout" state={{ totalWithCourier }}>
        <motion.button
