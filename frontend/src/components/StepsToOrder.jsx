const StepsToOrder = () => {
    ...
    return (
        <div className="bg-black text-white py-16 px-4 sm:px-6 lg:px-8">
            <h2 className="text-center text-3xl sm:text-4xl font-semibold text-green-400 mb-8">
                How to Order
            </h2>
            <div className="max-w-3xl mx-auto">
                {steps.map((step, index) => (
                    <div key={index} className="mb-6 flex items-start">
                        <div className="flex-shrink-0 w-12 h-12 bg-green-400 text-black font-bold text-xl flex items-center justify-center rounded-full mr-4">
                            {step.step}
                        </div>
                        <div>
