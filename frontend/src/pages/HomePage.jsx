...
import StepsToOrder from "../components/StepsToOrder"; // Import StepsToOrder
...
const HomePage = () => {
  ...
  return (
    <div className="relative mt-8 min-h-screen text-white overflow-hidden">
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div className="bg-gradient-to-r from-blue-900 to-blue-600 p-8 rounded-lg shadow-lg text-center">
      ...
      <div className="bg-black text-white py-0 px-4 sm:px-6 lg:px-8">
