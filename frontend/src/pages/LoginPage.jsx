...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center mt-8 py-12 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <h2 className="mt-6 text-center text-2xl sm:text-3xl font-extrabold text-emerald-400">
