...
await sendEmail(
  ...
  email1Html
      ...
      if (checkout.shippingAddress) {
        ...
        collectionDate.setDate(collectionDate.getDate() + 3); // Collection date is 3 days from now
        ...
        const email3Html = `
          ...
          <p>Name: <strong>George Holtzhausen</strong></p>
          <p>Mobile: <strong>0788241107</strong></p>
          <p>Email: <strong>vanderholtzpromotions@gmail.com</strong></p>
